...
from qiskit_algorithms.algorithm_job import AlgorithmJob # <-- we should remove any dependency to qiskit_algorithms (copy what is needed)
from qiskit_algorithms.minimum_eigensolvers.diagonal_estimator import _DiagonalEstimatorResult # <-- we should remove any dependency to qiskit_algorithms (copy what is needed)
